...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        payload = {
            'title': 'Cambodia curry',
            'time_minutes': 30,
            'price': Decimal('2.19'),
            'tags': [{'name': 'Khmer'}, {'name': 'Breakfast'}]
        }
    ...
    def test_create_tag_on_update(self):
        """Tes creating tag when updating a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('2.4'),
            'ingredients': [{'name': 'Flower'}, {'name': 'Flower1'}]
        }
    ...
    def test_create_recipe_with_exsting_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 26,
            'price': Decimal('4.10'),
            'ingredient': [{'name': 'Lemond'}, {'name': 'Fish'}]
        }
